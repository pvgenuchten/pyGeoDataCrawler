...
"VECTOR_FILE_TYPES": ['shp', 'mvt', 'dxf', 'dwg', 'fgdb', 'gml', 'gpx', 'kml', 'geojson', 'gpkg', 'sqlite', 'kmz', 'parquet']
}
driverSupport = {'shp':'ESRI Shapefile', 'parquet':'Parquet', 'dwg': 'CAD','fgdb': 'OpenFileGDB', 'gpkg': 'GPKG', 'sqlite': 'SQLite' } 
