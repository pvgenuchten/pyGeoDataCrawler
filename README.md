...
```
docker build -t pvgenuchten/geodatacrawler:1.3.8 .
docker login
docker push pvgenuchten/geodatacrawler:1.3.8
docker tag pvgenuchten/geodatacrawler:1.3.8 pvgenuchten/geodatacrawler:latest
