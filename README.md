...
```
docker build -t pvgenuchten/geodatacrawler:1.3.14 .
docker login
docker push pvgenuchten/geodatacrawler:1.3.14
docker tag pvgenuchten/geodatacrawler:1.3.14 pvgenuchten/geodatacrawler:latest
